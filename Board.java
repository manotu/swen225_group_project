...
public class Board {
     ...
     *      - _'s are rooms or corridors
     *      - ░'s are walls, i.e. inaccessible areas.
     *
    ...
    public void display() {
        ...
        for (int row = 0; row < ROWS; row++) {
            ...
            if (row == 3) System.out.print("KITCHEN");
            else if (row == 11)  System.out.print(" DINING");
            else if (row == 12) System.out.print("   ROOM");
            else if (row == 22) System.out.print(" LOUNGE");
            ...
            if (row == 2) System.out.print("CONSERVATORY");
            else if (row == 9) System.out.print("BILLIARD");
            else if (row == 10) System.out.print("ROOM");
            else if (row == 16) System.out.print("LIBRARY");
            else if (row == 23) System.out.print("STUDY ");
            System.out.println();
        }
